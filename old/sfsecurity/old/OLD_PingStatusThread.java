...
/** THIS IS AN OLD VERSION OF PINGSTATUSTHREAD USED TO TEST THE FREQUENCY OF PINGS ON A DEVICE */
public class OLD_PingStatusThread extends Thread {
	boolean found;
	...
	public OLD_PingStatusThread(Core core, Thread t) {
		this.core = core;
		found = false;
...
//				System.out.println(false);
	...
	public static void main(String[] args) {
		OLD_PingStatusThread ps = new OLD_PingStatusThread(new Core(), new Thread());
		ps.start();
	}
